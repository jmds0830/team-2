      ...
      <div className={styles.mainContainer}>
        <div className={styles.leftContainer}>
          <div className={styles.announcementContainer}>
            ...
            <p>
              EnSys is now up and running! You can now enroll and book your
              payment schedules online!
            </p>
          </div>
          <div className={styles.appIntroContainer}>
            <img alt="img" src={imageSource} className={styles.articleImage} />
            <p>
              EnSys is an online enrollment system for students. Created in
              2024, Ensys aims to provide a covenient registration process for
              students. It allows students to use their online school accounts
              to manage their subjects and book payment schedules anywhere with
              internet access.
            </p>
          </div>
